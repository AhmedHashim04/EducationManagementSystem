...
class CourseMaterial(models.Model):
    ...
    file = models.FileField(_("File"), upload_to='course_materials/', blank=True, null=True)
    video_url = models.URLField(_("Video URL"), blank=True, null=True)
    pdf_file = models.FileField(_("PDF File"), upload_to='course_materials/', blank=True, null=True)
    slides_file = models.FileField(_("Slides File"), upload_to='course_materials/', blank=True, null=True)
