...
from .views import CreatAssignment, AssignmentDetailView ,SolveAssignment ,GradeAssignment
...
urlpatterns = [
    ...
    path('<str:course_code>/assignments/<int:assignment_id>/grade', GradeAssignment.as_view(), name='assignment_grade'),
